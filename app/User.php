...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany('App\Assignment', 'grades')->withPivot('done');
    }

    public function getAssignments()
    {
        $assignments = $this->assignments()->select('assignments.id', 'assignments.name', 'assignments.course_id', 'assignments.dueTime')->where('grades.done', false)->get();
