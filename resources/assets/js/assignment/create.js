...
var matching = "<div class='matching mb-5 card'><h5 class='mb-3 card-header col-md-12'>" + messages['matchingQuestions'] + "</h5><div class='card-body'><textarea rows='5' class='form-control col-md-12' style='display: none'></textarea><div class='form-group-vertical' id='matching_" + num_of_questions[2] + "'><div class='row'><input class='form-control col-md-5 mb-3 ml-5 mr-4' placeholder='" + messages['leftChoice'] + "'><input class='form-control col-md-5 mb-3 ml-5' placeholder='" + messages['rightChoice'] + "'></div></div><button class='btn btn-outline-secondary pull-right add_choice' id='add_to_matching_" + num_of_questions[2] + "'>" + messages['addMatch'] + "</button></div></div>";
var essay = "<div class='essay mb-5 card'><h5 class='mb-3 card-header col-md-12'>" + messages['essayQuestion'] + "</h5><div class='card-body'><textarea rows='5' class='form-control col-md-12' style='display: none'></textarea><textarea rows='6' class='form-control text-left col-md-12' placeholder='" + messages['essayPrompt'] + "'></textarea></div>";
var choice = "<input placeholder='" + messages['choice'] + "' class='form-control col-md-10 mb-3 mr-4 ml-3'><label class='custom-control custom-checkbox ml-5'><input type='checkbox' class='custom-control-input col-md-2'><span class='custom-control-indicator'></span><span class='custom-control-description'></span></label></div>";
var match_pair = "<input class='form-control col-md-5 mb-3 ml-5 mr-4' placeholder='" + messages['leftChoice'] + "'><input class='form-control col-md-5 mb-3 ml-5' placeholder='" + messages['rightChoice'] + "'>";
