	    ...
	    <ul class="list-group list-group-flush">
	        <li v-for="(question, index) in questions" class="list-group-item">
	        	<div v-if="answer[index].equals(correct[index])" class="border-success">
		            <div v-if="question.type === 'multiple_choice'" v-bind:id="index" v-bind:type="question.type">
		                {{--multiple choice--}}
		            ...
		            <div v-else-if="question.type === 'fill_in_the_blank'" v-bind:id="index" v-bind:type="question.type">
		                {{--fill the blank--}}
		            </div>
	           	</div>
